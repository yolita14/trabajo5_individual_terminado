...
ActiveRecord::Schema[7.0].define(version: 2022_10_14_134829) do
  ...
  create_table "etiqueta_publicacions", id: false, force: :cascade do |t|
    t.bigint "etiquetum_id", null: false
